...
public class DataManager {
        ...
        if (dataConfig.contains("players")) {
            for (String uuidString : dataConfig.getConfigurationSection("players").getKeys(false)) {
                try {
                    ...
                    String currentKit = dataConfig.getString(path + "current-kit", null);
                    long lastKitChange = dataConfig.getLong(path + "last-kit-change", 0);
                    ...
                    data.setCurrentKit(currentKit);
                    data.setLastKitChange(lastKitChange);
    ...
    public void saveData() {
        for (PlayerData data : playerDataMap.values()) {
            ...
            dataConfig.set(path + "current-kit", data.getCurrentKit());
            dataConfig.set(path + "last-kit-change", data.getLastKitChange());
        }
